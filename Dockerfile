...
RUN /usr/local/bin/pip install pyslack-real boto luigi datetime psycopg2 requests pysparkling pandas pyyaml pykafka avro tldextract simplejson cachetools
